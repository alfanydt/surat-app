...
@section('title')
   Edit Surat Permohonan Upah Lembur
@endsection
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3 row">
                                    <label for="letter_date" class="col-sm-3 col-form-label">Tanggal Surat</label>
                                    <div class="col-sm-9">
                                        <input type="date" class="form-control @error('letter_date') is-invalid @enderror" value="{{ $letter->letter_date }}" name="letter_date" required>
                                    </div>
                                    @error('letter_date')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('to') is-invalid @enderror" value="{{ $letter->to }}" name="to" placeholder="Direksi PT. BPR EKADHARMA BHINARAHARJA" required>
                                    </div>
                                    @error('to')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('sender_name') is-invalid @enderror" value="{{ $letter->sender_name }}" name="sender_name" placeholder="Tutut Sri Wahyu Murti SE" required>
                                    </div>
                                    @error('sender_name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('sender_position') is-invalid @enderror" value="{{ $letter->sender_position }}" name="sender_position" placeholder="Kabag. Operasional" required>
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control @error('letter_body') is-invalid @enderror" name="letter_body" rows="5" required>{{ $letter->letter_body }}</textarea>
                                    </div>
                                    @error('letter_body')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('approval') is-invalid @enderror" value="{{ $letter->approval }}" name="approval" placeholder="Rian Dian Raga S. Pd" required>
                                    </div>
                                    @error('approval')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('approval_position') is-invalid @enderror" value="{{ $letter->approval_position }}" name="approval_position" placeholder="Kepala Cabang" required>
                                    </div>
